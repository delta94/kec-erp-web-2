...
class AttendanceTable extends Component{
    ...
    handleChange=(event)=>{
        ...
        [name]: value 
            ...
            this.updatetableData(this.state.siteId,this.state.fromDate,this.state.toDate);
        });
    }
        
    componentWillMount(){
        console.log("inside component will mount");
    axios.get(/*'https://kunnel-erp.herokuapp.com/sitemanage/sites/'*/'http://ec2-13-127-182-134.ap-south-1.compute.amazonaws.com/sitemanage/sites/',{headers:{
...
updatetableData=(x,y,z)=>{
    ...
    axios.post(/*'https://kunnel-erp.herokuapp.com/attendancemanage/allAttendance'*/'http://ec2-13-127-182-134.ap-south-1.compute.amazonaws.com/attendancemanage/allAttendance',data,{headers:{
        'Authorization': `token ${localStorage.getItem('token')}`
    }})
    .then(response => {
